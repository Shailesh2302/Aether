      ...
      >
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">Ask about this video</h3>
            <p className="text-sm text-muted-foreground max-w-sm">
              Ask questions about the video content. The AI will use the transcript to provide accurate answers with timestamp references.
            </p>
          </div>
        ) : (
